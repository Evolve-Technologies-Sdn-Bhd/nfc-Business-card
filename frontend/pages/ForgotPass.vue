    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-secondary-100 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <h2 class="mt-6 text-3xl font-bold text-secondary-900">Reset your password</h2>
            ...
            <div v-if="emailSent" class="card p-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-secondary-900 mb-2">Check your email</h3>
                    <p class="text-secondary-600 mb-6">
                        If an account exists for <strong>{{ form.email }}</strong>, you'll receive password reset instructions shortly.
                    </p>
                    <div class="space-y-3">
            ...
            <div v-else class="card p-8">
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <button type="submit" :disabled="loading || !form.email" class="btn btn-primary w-full">
            ...
            <div class="text-center text-sm text-secondary-600">
                <p>Having trouble? <a href="mailto:support@nfcgo.com" class="text-primary-600 hover:text-primary-500">Contact support</a></p>
            </div>
        </div>
    </div>
</template>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        if (error.response?.status === 429) {
            ...
            errors.value = { email: ['Too many reset attempts. Please try again later.'] }
