            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center space-x-4">
                        <div>
                            <h1 class="text-2xl font-semibold text-secondary-900">Analytics Dashboard</h1>
                            <p class="text-sm text-secondary-600">Track your NFC card performance</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-4">
                        ...
                        <button v-else @click="refreshAnalytics" class="btn btn-outline btn-sm">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div v-else-if="!userNfcTag" class="text-center py-12">
                <div class="max-w-md mx-auto">
                    ...
                    <h3 class="text-xl font-semibold text-secondary-900 mb-2">No NFC Card Found</h3>
                    <p class="text-secondary-600 mb-6">
                        You don't have an active NFC card yet. Order a physical card to start tracking analytics.
                    </p>
                    <div class="space-x-4">
            ...
            <div v-else>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-blue-700 mt-1">
                                    You're viewing basic analytics. Upgrade to Pro for detailed insights, device
                                    breakdowns,
                ...
                <div class="mb-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="text-lg font-medium text-secondary-900">NFC Card Information</h3>
                        </div>
                        <div class="card-body">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <p class="text-sm font-medium text-secondary-500">Card Name</p>
                                    <p class="text-lg font-semibold text-secondary-900">{{ userNfcTag.name }}</p>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-secondary-500">NFC ID</p>
                                    <p class="text-lg font-semibold text-secondary-900">{{ userNfcTag.nfc_id }}</p>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-secondary-500">Status</p>
                                    <span :class="getStatusBadgeClass(userNfcTag.status)"
                    ...
                    <div class="card p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-success-600">+{{ analytics.engagementGrowth }}% from last period
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <button @click="viewDetailedAnalytics" class="btn btn-outline w-full">
                                    <Icon name="heroicons:chart-bar" class="h-4 w-4 mr-2" />
                                    View Detailed Analytics
                                </button>
                                <button @click="navigateToCardManagement" class="btn btn-outline w-full">
                                    <Icon name="heroicons:credit-card" class="h-4 w-4 mr-2" />
                                    Manage Cards
                                </button>
...
const viewDetailedAnalytics = () => {
    if (userNfcTag.value) {
        navigateTo(`/dashboard/links/${userNfcTag.value.id}/analytics`)
    }
}

const navigateToCardManagement = () => {
    navigateTo('/dashboard/card-management')
}
