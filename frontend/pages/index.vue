      ...
      <div class="container">
        <div class="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          <div class="mb-8 lg:mb-0 animate-fade-in-up">
            <h1
              class="text-4xl md:text-5xl lg:text-6xl font-bold text-secondary-900 mb-6 leading-tight"
            >
              Your Digital Business Card,
              <span class="text-gradient">One Tap Away</span>
            </h1>
            <p class="text-xl text-secondary-600 mb-8 leading-relaxed">
              Create smart NFC business cards that instantly share your
              professional profile. Modern networking made simple with just a
              tap.
            </p>
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <div>
                  <Icon
                    name="heroicons:wifi"
                    class="h-8 w-8 text-white/60 animate-pulse"
                  />
                </div>
              </div>
              <div>
