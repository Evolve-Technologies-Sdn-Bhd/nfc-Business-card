/**
 * Complete list of country phone codes (195+ countries)
...
// Popular countries to show at top of dropdown
export const popularCountries = ['MY', 'SG', 'US', 'GB', 'AU', 'CN', 'IN', 'ID', 'TH', 'PH'];

// Default country
export const defaultCountry = 'MY';

// Get country by code
export const getCountryByCode = (code) => {
  return countryPhoneCodes.find(c => c.code === code) || countryPhoneCodes.find(c => c.code === 'MY');
};

// Get country by dial code
export const getCountryByDialCode = (dialCode) => {
  const normalized = dialCode.startsWith('+') ? dialCode : '+' + dialCode;
  return countryPhoneCodes.find(c => c.dialCode === normalized);
};
...
// Get sorted list with popular countries at top
export const getSortedCountries = () => {
  const popular = popularCountries
    .map(code => countryPhoneCodes.find(c => c.code === code))
    .filter(Boolean);
  const rest = countryPhoneCodes.filter(c => !popularCountries.includes(c.code));
  return [...popular, ...rest];
};
