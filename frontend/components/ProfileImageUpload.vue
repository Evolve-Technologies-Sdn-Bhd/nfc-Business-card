        ...
        <div class="flex items-center space-x-4">
            <div class="relative">
                <div v-if="imageUrl" class="relative">
                    ...
                    <button v-if="!uploading" @click="removeImage"
                ...
                <div v-else
                    ...
                    <img src="/default-avatar.png" alt="Default avatar" class="w-20 h-20 rounded-full object-cover" />
                </div>
                ...
                <button @click="$refs.fileInput.click()" :disabled="uploading"
                    ...
                    <Icon v-if="!uploading" name="heroicons:camera" class="w-4 h-4 text-gray-600" />
...
const uploadFile = async (file) => {
    ...
    try {
        ...
        formData.append(props.uploadEndpoint.includes('logo') ? 'logo' : 'image', file)
        ...
        // Send request
        xhr.open('POST', `${useRuntimeConfig().public.apiBaseUrl}${props.uploadEndpoint}`)
