    ...
    <div class="email-container">
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value"><strong>{{ $data['company_name'] }}</strong></div>
            </div>

            <div class="info-row">
                <div class="info-label">Company Address:</div>
                <div class="info-value">{{ $data['company_address'] }}</div>
            </div>

            <div class="info-row">
                <div class="info-label">NFC Cards Needed:</div>
                <div class="info-value">
                    <span class="badge">{{ $data['quota'] }} cards</span>
                </div>
            </div>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ $data['contact_person'] }}</div>
            </div>
        ...
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <div class="info-value"><a href="mailto:{{ $data['user_email'] }}">{{ $data['user_email'] }}</a></div>
            </div>
        ...
        <div class="notes-section">
            ...
            <p style="margin: 10px 0 0 0; color: #374151;">{{ $data['notes'] }}</p>
        </div>
        @endif
